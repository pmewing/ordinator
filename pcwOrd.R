...
pcwOrd = function(Y, X=NULL, Z=NULL, weight_rows=FALSE, weight_columns=FALSE, as_CA=FALSE, as_vegan=FALSE) {
  ...
  # weight_rows: logical or numeric. If TRUE, will weight by nrow(Y).
  # weight_columns: logical or nueric. If TRUE, will weight by ncol(Y).
  # as_CA: NOT IMPLEMENTED. run as correspondence analysis? If TRUE, weights of rows and columns are overrridden as TRUE
  #   and Y is double-standardized. If FALSE, Y is centered and weights are not overriden.
